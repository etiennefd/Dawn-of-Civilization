...
iGermany, iAmerica, iArgentina, iBrazil, iCanada, iIsrael) = range(iNumPlayers)
...
pGermany, pAmerica, pArgentina, pBrazil, pCanada, pIsrael) = [gc.getPlayer(i) for i in range(iNumPlayers)]
...
teamGermany, teamAmerica, teamArgentina, teamBrazil, teamCanada, teamIsrael) = [gc.getTeam(i) for i in range(iNumPlayers)]
...
iPanzer, iMainBattleTank, iMerkava, iGunship, iCatapult, iHwacha, iTrebuchet, iBombard, iSiegeElephant, iCannon, iHeavyCannon, 
...
iGeorge, iKhosrow, iBumin, iTamerlane, iBenGurion) = range(iNumLeaders)
