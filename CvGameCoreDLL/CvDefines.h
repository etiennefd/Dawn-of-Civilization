...
#ifdef _USRDLL
#define MAX_CIV_PLAYERS												(52) //Rhye, Leoreth: +17 for Byzantium, Korea, Indonesia, Mughals, Thailand, Turks, Prussia/HRE, Italy, Tamils, Poland, Moors, Congo, Tibet, Brazil, Argentina, Canada, Polynesia, Harappa, Teotihuacan, Israel, Muisca
#else
